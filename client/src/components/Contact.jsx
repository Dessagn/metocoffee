            ...
            <div className="contact">
                ...
                <div className="row container">
                    <form action="/contact/sendMessage" method="post" data-toggle="validator" className="form-horizontal">
                        ...
                        <div className="col-sm-8">
                            <input id="email" type="email" name="email" placeholder="Email" data-error="Email format not valid" className="form-control input-lg" required/>
                        ...
                        <div className="col-sm-8">
                            <input id="email" type="email" name="email" placeholder="Retype email" data-error="Email format not valid" className="form-control input-lg" required/>
                            <div className="help-block with-errors"></div>
                        </div>
                        </div>
                        <div className="form-group">
